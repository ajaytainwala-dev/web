            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    <div className=" mx-auto max-w-screen-sm text-center">
                        <Image
                            alt="notFound"
                            src="/Placeholder/404-computer.svg"
                            height={400}
                            width={400}
                            className="m-auto"
                        />
                        ...
                        <p className="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">Sorry, we can&apos;t find this page. You&apos;ll find lots to explore on the home page. </p>
