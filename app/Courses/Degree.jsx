...
const Degree_Programs = [
  {
    icon: <TbBusinessplan />,
    title: "Bachleor of Commerece (B.Com)",
  },
  {
    icon: <FaPeopleGroup />,
    title: "Bachleor in Business Adminstration (BBA)",
  },
  {
    icon: <SlChemistry />,
    title: "Bachleor of Science (B.Sc)",
  },
  {
    icon: <FaComputer />,
    title: "Bachleor of Computer Applications (BCA)",
  },
];
