...
const Loading = () => {
  return (
    <>
      ...
      <div role="status" className="space-y-2.5 animate-pulse max-w-lg p-5">
...
<div role="status" className="max-w-md p-5 space-y-4 border border-gray-200 divide-y divide-gray-200 rounded shadow animate-pulse dark:divide-gray-700 md:p-6 dark:border-gray-700">
